<template>
  <div>
    <div>
      <p class="cards-category">New on Movieflix</p>
      <div class="cards-container-new">
        <div v-for="movie in movies.new" :key="movie.id" class="card" @mouseover="toggleHover(movie.id, true)" @mouseleave="toggleHover(movie.id, false)">
