<template>
  <div>
    <div>
      <p class="cards-category">Most Voted on Movieflix</p>
      <div class="cards-container-mostvoted">
        <div v-for="movie in movies.voted" :key="movie.id" class="card" @mouseover="toggleHover(movie.id, true)" @mouseleave="toggleHover(movie.id, false)">
